...
/**
 * @file
 * Contains \ChiTeck\TextFormatter\Utility\Url.
 */
 ...
 *
 * @see https://api.drupal.org/api/drupal/core%21lib%21Drupal%21Component%21Utility%21Url.php/class/Url/8
 */
class Url
{
    ...
    /**
     * Returns whether a path is external to site (e.g. http://example.com).
     *
     * @param string $path
     ...
     *
     * This function should only be used on actual URLs. Valid values per RFC 3986.
     *
     * @param string $url
     *   The URL to verify.
     * @param bool $absolute
